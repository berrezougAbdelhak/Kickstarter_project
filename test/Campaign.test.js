...
describe("Campaigns",() =>{
    ...
    it("requiresa minimum contribution",async()=>{
        try{
            await campaign.methods.contribute().send({
                value:"99",
                from:accounts[1]
    ...
    it("processes requests",async()=>{
        ...
        //Here balance is a string of wei
        let balance=await web3.eth.getBalance(accounts[1])
        //Balance is a string of ether
        balance=web3.utils.fromWei(balance,"ether")
        //parseFloat to convert a string to a decimal number 
